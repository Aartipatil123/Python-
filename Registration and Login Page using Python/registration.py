...
frame = tk.LabelFrame(window, text="", width=600, height=570, bd=5, font=('times', 14, ' bold '),bg="#138d75")
frame.grid(row=0, column=0, sticky='nw')
frame.place(x=510, y=170)

lbl = tk.Label(window, text="Registration Form", font=('times', 35,' bold '), height=2, width=55,bg="#566573",fg="black")
lbl.place(x=0, y=0)
